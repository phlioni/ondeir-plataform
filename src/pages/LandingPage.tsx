...
import { Helmet } from 'react-helmet-async'; // <--- REMOVIDO O "HelmetProvider" DAQUI
...
const SEO_DATA = {
    ...
    url: "https://appflippi.com", // <--- Ajustado para o domínio que você mandou no relatório
...
export default function LandingPage() {
    ...
    // REMOVIDO: <HelmetProvider> (Já está no App.tsx)
    return (
